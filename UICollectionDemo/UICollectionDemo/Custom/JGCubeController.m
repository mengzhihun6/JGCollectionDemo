...
#import "JGCubeController.h"
#import "JGCubeFlowLayout.h"

@interface JGCubeController () <UICollectionViewDelegate,UICollectionViewDataSource>{
...
@implementation JGCubeController
...
- (void)viewDidLoad {
    ...
    self.navigationItem.title = @"立方形";

    JGCubeFlowLayout * layout = [[JGCubeFlowLayout alloc]init];
